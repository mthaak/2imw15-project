...
"""
    Calls the enrichTweets function of the TweetEnricher class for all tweets in collection.
    Three matrices, stored as pickles, are generated as a result.
    /Data/Features.pickle
    /Data/Features_basic.pickle
    /Data/Features_binary.pickle
    Details of each is in Data/README.txt
"""


READ_FILENAME="../Data/tweets_ 20161024_111847_assertionlabeled.csv"
WRITE_FILENAME="../Data/04_11/highIG/Features.pickle"
WRITE_BASIC_FILENAME="../Data/04_11/highIG/Features_basic.pickle"
WRITE_BINARY_FILENAME = "../Data/04_11/highIG/Features_binary.pickle"
...
#create n-gram count matrix and get list of features(basic and with n grams)-- As tweet n-gram run already, we don't want to run it again. Hence, the boolean.
basic_tweet_features,tweet_features,collection_n_gram_count_matrix = tweet_enricher.createNGramCountMatrix(collection,SA_tagged_collection,False)
