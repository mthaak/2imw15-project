...
class TweetEnricher:
    ...
    def __init__(self):
        ...
        self.vectorizer = CountVectorizer(ngram_range=(1, 3), tokenizer=self.tokenizer.tokenize,
                                          stop_words=list(self.stopset) + self.web_abbreviations + list(
                                              string.punctuation))
    ...
    def tweetFeatures(self):
        self.tweet_features = ["VulgarWords", "Emoticons", "Interrogation",
                               "Exclamation", "Abbreviations", "TwitterJargons", "#", "# position", "@", "@ position",
                               "RT", "RT position", "Link"]
    ...
    def enrichTweets(self, tweet):
        ...
        # add twitter jargon's feature
        row.append(self.hasTwitterJargons(tokens))
        # add Twitter specific character's features- presence and position
